        ...
        <div className={style.login}>
            ...
            <div className={style.container}>
                ...
                <div id={style.suggestions}>
                    <input type="checkbox" />  <span id={style.remember}>Remember Me? </span> <span id={style.forgot_password}><Link style={{ textDecoration: 'none', color: 'red', fontSize: "14px" }} to="/forgot-password">Forgot Password?</Link></span>
                </div>
